...
Const.UX3320S_Controls = 0x03

Const.UX3320S_Chip_ID = "UX3320S0"

PW1_Set = Register()
PW1_Set.table = Const.UX3320S_Controls
PW1_Set.register = 0xd3
PW1_Set.length = 4
PW1_Set.name = "PW1 Settings"

PW2_Set = Register()
PW2_Set.table = Const.UX3320S_Controls
PW2_Set.register = 0xd7
PW2_Set.length = 4
PW2_Set.name = "PW2 Settings"

Security = Register()
Security.table  = Const.UX3320S_Controls
...
Burst_Continuous.table = Const.UX3320S_Controls
...
RAM_CTRL.length = 83
RAM_CTRL.cs_en = 0xA1
RAM_CTRL.cs_en_d = 0xFE
RAM_CTRL.all_write = 0xA1
...
RAM_TEST_UX3320S = [RAM_04H_BIAS,RAM_05H_MOD,RAM_06H_APD,RAM_CTRL]
