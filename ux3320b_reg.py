...
Const.UX3320B_Controls = 0x03

Const.UX3320B_Chip_ID = "UX3320B"

Chip_ID = Register()
Chip_ID.table = Const.UX3320B_Controls
Chip_ID.register = 0xef
Chip_ID.name = "Chip distinguish reg"
...
RAM_TEST_UX3320B = [RAM_04H_BIAS,RAM_05H_MOD,RAM_06H_APD,RAM_CTRL]